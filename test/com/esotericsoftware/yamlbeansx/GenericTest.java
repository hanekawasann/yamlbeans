...
public class GenericTest extends TestCase {
    ...
    public void testRead() throws YamlxException {
        Test test = createTest();

        Test read = new YamlxReader(YAML).read(Test.class);
        Assert.assertEquals(test, read);
    }

    public void testWrite() throws YamlxException {
        Test test = createTest();
        StringWriter stringWriter = new StringWriter();

        YamlxWriter yamlWriter = new YamlxWriter(stringWriter);
